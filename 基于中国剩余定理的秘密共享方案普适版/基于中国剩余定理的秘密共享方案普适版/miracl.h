...
#ifndef MR_STATIC
extern BOOL  ebricchengji2_init(_MIPT_ ebricchengji2 *,big,big,big,big,int,int,int,int,int,int);
extern void  ebricchengji2_end(ebricchengji2 *);
#else
extern void  ebricchengji2_init(ebricchengji2 *,const mr_small *,big,big,int,int,int,int,int,int);
#endif
extern int   mul2_brick(_MIPT_ ebricchengji2*,big,big,big);
